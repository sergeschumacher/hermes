...
// Module loader
const modules = {};
const moduleOrder = ['logger', 'settings', 'db', 'tmdb', 'llm', 'enrichment', 'iptv', 'newznab', 'usenet', 'usenet-postprocess', 'source-analyzer', 'epg', 'scheduler', 'transcoder', 'download', 'plex', 'overseerr', 'search', 'app'];
